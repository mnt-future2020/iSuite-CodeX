...
// LiteLLM does not return the compatible iSuite CodeX models with the provider, so we list them here to set them ourselves
...
// Default model for iSuite CodeX provider
