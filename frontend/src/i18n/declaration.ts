...
export enum I18nKey {
  ...
  HOME$ISUITE_DESCRIPTION = "HOME$ISUITE_DESCRIPTION",
  ...
  BRANDING$ISUITE = "BRANDING$ISUITE",
  BRANDING$ISUITE_LOGO = "BRANDING$ISUITE_LOGO",
  ...
  CONFIGURATION$ISUITE_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$ISUITE_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$ISUITE_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$ISUITE_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
  ...
  SETTINGS$NEED_ISUITE_ACCOUNT = "SETTINGS$NEED_ISUITE_ACCOUNT",
  ...
  SETTINGS$ISUITE_API_KEY_HELP = "SETTINGS$ISUITE_API_KEY_HELP",
  SETTINGS$ISUITE_API_KEY_HELP_TEXT = "SETTINGS$ISUITE_API_KEY_HELP_TEXT",
  SETTINGS$ISUITE_API_KEY_HELP_SUFFIX = "SETTINGS$ISUITE_API_KEY_HELP_SUFFIX",
  ...
  SYSTEM_MESSAGE_MODAL$ISUITE_VERSION = "SYSTEM_MESSAGE_MODAL$ISUITE_VERSION",
  ...
  SETTINGS$ISUITE_API_KEYS = "SETTINGS$ISUITE_API_KEYS",
  ...
  MICROAGENT_MANAGEMENT$ISUITE_CAN_LEARN_ABOUT_REPOSITORIES = "MICROAGENT_MANAGEMENT$ISUITE_CAN_LEARN_ABOUT_REPOSITORIES",
